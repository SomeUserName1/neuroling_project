...
class DeepDenseNet(AbstractNet):
    ...
    def build(self):
        ...
        x = Dense(64, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc1')(x)
        x = Dense(32, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc2')(x)
        x = Dense(16, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc3')(x)
        x = Dense(8, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc4')(x)
        x = Dense(4, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc5')(x)
        x = Dense(2, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc6')(x)
        b = Dense(1, activation='relu', kernel_initializer='glorot_normal', bias_initializer='zeros', name='3fc7')(x)
        self.model = Model(a, b)
        super().build()